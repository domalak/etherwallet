...
/* New Generics */
x_CancelReplaceTx           : 'Транзакцияны Болдырмау не Алмастыру',
x_CancelTx                  : 'Транзакцияны Болдырмау',
x_PasswordDesc              : 'Осы кілтсөз жеке кілтіңізді * шифрлайды *. Бірақ ол кілттеріңізді өндіретін тұқым емес. **Әмияныңызды ашу үшін  кілтсөз + жеке кілт керек.**',
x_ReadMore                  : 'Толық Оқу',
x_ReplaceTx                 : 'Транзакцияны Алмастыру',
x_TransHash                 : 'Транзакция Хэшы',
x_TXFee                     : 'ТХ Ақысы',
x_TxHash                    : 'ТХ Хэшы',

/* Check TX Status */
NAV_CheckTxStatus           : 'ТХ Статусын Тексеру',
NAV_TxStatus                : 'ТХ Статусы',
tx_Details                  : 'Транзакция Құрамы',
tx_Summary                  : 'During times of high volume (like during ICOs) transactions can be pending for hours, if not days. This tool aims to give you the ability to find and "cancel" / replace these TXs. ** This is not typically something you can do. It should not be relied upon & will only work when the TX Pools are full. [Please, read about this tool here.](https://myetherwallet.groovehq.com/knowledge_base/topics/how-can-i-check-on-the-status-of-my-transaction-can-i-cancel-override-overwrite-replace-or-do-anything-once-a-transaction-has-been-sent)** Үлкен көлемді оқиғалар кезінде (ICO сияқты) транзакциялардың өтуі бірнеше сағатқа, кейде бірнеше күнге созылуы мүмкін. Осы құрал сізге сондай ТХ-ларды тауып, "болдырмау" / алмастыру мүмкіндігін береді. **  **',
